...
const user = {
  ...
  website: 'https://magnuschess.com',
  bio: 'World Chess Champion. Just here to play some casual games and have fun.',
};
...
const gameHistory = [
  { id: '1', opponent: 'hikaru', result: 'win', moves: 34, date: '2024-01-15', rating: 2785, opening: 'Sicilian Defense' },
  { id: '2', opponent: 'firouzja', result: 'draw', moves: 52, date: '2024-01-14', rating: 2760, opening: "Italian Game" },
  { id: '3', opponent: 'caruana', result: 'loss', moves: 41, date: '2024-01-13', rating: 2795, opening: "Queen's Gambit" },
  { id: '4', opponent: 'nepo', result: 'win', moves: 28, date: '2024-01-12', rating: 2755, opening: 'Ruy Lopez' },
  { id: '5', opponent: 'ding', result: 'win', moves: 56, date: '2024-01-11', rating: 2780, opening: 'French Defense' },
  { id: '6', opponent: 'anish', result: 'draw', moves: 45, date: '2024-01-10', rating: 2750, opening: 'English Opening' },
];
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex-1 text-center sm:text-left">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-2">
                  ...
                  <span className="inline-flex items-center justify-center sm:justify-start gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/30 text-sm">
                    ...
                    <span className="font-display font-bold text-primary">{user.rating}</span>
                  </span>
                </div>
          ...
          <div className="card p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-display font-semibold text-foreground">Rating Progress</h2>
              <span className="text-sm text-foreground-muted">
                Peak: <span className="text-primary font-semibold">{user.peakRating}</span>
              </span>
            </div>
